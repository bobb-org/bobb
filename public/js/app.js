...
/* harmony import */ var _routes_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./routes/index */ "./resources/js/router/routes/index.js");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_2__.default({
  routes: [{
    path: '/',
    redirect: '/dashboard'
  }].concat(_routes_index__WEBPACK_IMPORTED_MODULE_0__.default)
});
router.beforeEach(function (to, from, next) {
  var authenticated = false;
  var onlyForLoggedOut = to.matched.some(function (record) {
    return record.meta.onlyForLoggedOut;
  });
...
/***/ "./resources/js/router/routes/index.js":
/*!*********************************************!*\
  !*** ./resources/js/router/routes/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _public__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./public */ "./resources/js/router/routes/public.js");
/* harmony import */ var _private__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./private */ "./resources/js/router/routes/private.js");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_public__WEBPACK_IMPORTED_MODULE_0__.default.concat(_private__WEBPACK_IMPORTED_MODULE_1__.default));

/***/ }),

/***/ "./resources/js/router/routes/private.js":
/*!***********************************************!*\
  !*** ./resources/js/router/routes/private.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/router/routes/public.js":
/*!**********************************************!*\
  !*** ./resources/js/router/routes/public.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _pages_ForgotPassword_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @pages/ForgotPassword.vue */ "./resources/js/pages/ForgotPassword.vue");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
...
var routes = [{
  ...
  name: 'forgotPassword',
  component: _pages_ForgotPassword_vue__WEBPACK_IMPORTED_MODULE_1__.default
}];
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (routes.map(function (route) {
  var meta = {
    "public": true,
...
var actions = {
  login: function login(_ref, formData) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get('/sanctum/csrf-cookie').then(function () {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/login', formData).then(function (response) {
